...
excerpt: "내가 만든 서비스는 어느 정도의 가용성을 보유하는가?"
categories:
  - DevOps
tags:
  - DevOps
...
> 이 글은 [Pick-Git 기술 블로그](https://2021-pick-git.github.io/practice-nGrinder/)에 업로드한 글입니다.
...
CP 크기를 늘리더라도, 게시물 조회 트랜잭션 성능을 개선하지 못하는 이상 트랜잭션 스레드가 커넥션을 점유하는 시간은 여전히 길 것입니다. 즉, 늘린 CP 사이즈로도 감당하지 못할 트래픽이 몰린다면 동일한 HikariCP Connection Timeout 문제가 또다시 발생할 것으로 추정됩니다.
