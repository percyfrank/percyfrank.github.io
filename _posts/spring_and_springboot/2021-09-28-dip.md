---
title: "[Tecoble] DIP : 변경에 유연하고 테스트하기 좋은 코드 설계"
excerpt: "소프트웨어는 항상 변경이 발생하기 쉽다."
categories:
  - Spring & Spring Boot
tags:
  - Spring & Spring Boot
...
> 이 글은 [Tecoble](https://tecoble.techcourse.co.kr/post/2021-11-21-dip/) 및 [Pick-Git 기술 블로그](https://2021-pick-git.github.io/dip/)에 업로드한 글입니다.
