---
title: "[Tecoble] 관계형 DB에서 계층적인 데이터 관리하기"
excerpt: "중첩 세트 모델을 바탕으로 계층적인 데이터를 관리해보자."
categories:
  - Spring Data
tags:
  - Spring Data
...
> 이 글은 [Tecoble](https://woowacourse.github.io/tecoble/post/2021-09-03-hierarchy-data-with-rdb/)에 업로드한 글입니다.
